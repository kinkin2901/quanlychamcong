        ...
        <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form action="${pageContext.request.contextPath}/manager/leave-config-add" method="post" class="border p-4 rounded bg-white shadow-sm" style="max-width: 600px; margin: 0 auto;">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="defaultDays" class="form-control" required min="0">
                        </div>
